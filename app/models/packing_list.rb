class PackingList < ApplicationRecord
  ...
  accepts_nested_attributes_for :address, allow_destroy: true, reject_if: proc { |attributes| attributes.all? { |key, value| key == "_destroy" || value.blank? } }
  ...
  has_many :packing_list_items, as: :belongable, dependent: :destroy
