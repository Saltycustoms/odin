...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post statements_url, params: { statement: { grand_total_cents: @statement.grand_total_cents, net_total_cents: @statement.net_total_cents, order_id: @statement.order_id, shipment_total_cents: @statement.shipment_total_cents, subtotal_cents: @statement.subtotal_cents, tax_cents: @statement.tax_cents, type: @statement.type, uuid: @statement.uuid } }
    end
