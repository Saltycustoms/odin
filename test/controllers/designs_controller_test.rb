...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { order_id: @design.order_id, order_line_id: @design.order_line_id, properties: @design.properties } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { order_id: @design.order_id, order_line_id: @design.order_line_id, properties: @design.properties } }
