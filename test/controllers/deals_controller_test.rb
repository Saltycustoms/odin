...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { department_id: @deal.department_id, name: @deal.name, no_of_pcs: @deal.no_of_pcs } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { department_id: @deal.department_id, name: @deal.name, no_of_pcs: @deal.no_of_pcs } }
